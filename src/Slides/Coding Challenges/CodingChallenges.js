...
function CodingChallenges() {
    ...
    return (
        <ContainerLayout className="container-slide" id="coding-challenges" background={ colors.darkGray }>
            ...
            <div className={`container-content challenges-container ${ classes.root }`}>
                <Grid container spacing={2}>
                    <Grid item xs>
                        <h1 style={{ color:colors.weirdGreen}}>Easy</h1>
                    ...
                    <Grid item xs>
                        <h1 style={{ color:colors.weirdGreen}}>Medium</h1>
                    ...
                    <Grid item xs>
                        <h1 style={{ color:colors.weirdGreen}}>Hard</h1>
