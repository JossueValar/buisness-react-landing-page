    ...
    return (
        <>
            <Box className="header-icon" component="span" m={1}>
                <Button href="#about" className="logo-text"><strong>Team<b>Ing</b></strong></Button>
            </Box>
            <Box className="header-buttons" component="span" m={1}>
                <ThemeProvider theme={theme}>
                    <Button href="#about">About</Button>
                    <Button href="#projects-ref">Programs</Button>
                    <Button href="#coding-challenges-ref1">Free Challenges</Button>
